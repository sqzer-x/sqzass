...
[comrak]으로 렌더하는 CommonMark이고, 확장 몇 가지가 기본으로 켜져 있습니다. 각각이
...
**원시 HTML은 항상 통과합니다.** 콘텐츠는 믿을 수 있습니다. 저장소 안에 있고, 직접 썼고,
코드와 같은 커밋에서 리뷰됩니다. 이걸 새니타이즈하는 건 시늉입니다. sqzass가
언젠가 믿을 수 없는 마크다운을 받게 되면, 그건 전역 스위치가 아니라 소스별 신뢰
등급이 될 것입니다.
